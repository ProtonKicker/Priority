...
// Persistence keys
const STORAGE_KEY_CATEGORIES = 'priority_categories'
const STORAGE_KEY_TASKS = 'priority_tasks'
const STORAGE_KEY_THEME = 'priority_theme'
const STORAGE_KEY_SIDEBAR_WIDTH = 'priority_sidebar_width'
const STORAGE_KEY_ARCHIVE_PANEL_WIDTH = 'priority_archive_panel_width'
const STORAGE_KEY_ARCHIVED = 'priority_archived_tasks_by_workspace'
